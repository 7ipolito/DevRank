...
exports.CodeStatsService = void 0;
...
class CodeStatsService {
    constructor() {
        this.baseUrl = CODESTATS_BASE_URL;
    }
    async fetchCodeStatsUser(username) {
    ...
    async fetchUserStats(username) {
        try {
            ...
            const response = await axios_1.default.get(`${this.baseUrl}/api/users/${username}`, {
                headers: {
    ...
    async fetchMockUserStats(username) {
    ...
    async fetchUserStatsWithFallback(username) {
...
exports.CodeStatsService = CodeStatsService;
//# sourceMappingURL=CodeStatsService.js.map